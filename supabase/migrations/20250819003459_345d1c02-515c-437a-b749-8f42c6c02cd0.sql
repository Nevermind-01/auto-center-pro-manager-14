-- FASE 1: Criar estrutura de tabelas multi-tenant (corrigida)

-- Adicionar valor 'user' ao enum empresa_role existente
ALTER TYPE empresa_role ADD VALUE IF NOT EXISTS 'user';
