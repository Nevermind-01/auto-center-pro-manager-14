-- RPC finalizar OS robusto - versão simplificada das validações de totais
...
BEGIN
    ...
    -- Validar limites máximos realistas
    ...
    -- Processar produtos (validação robusta para arrays nulos)
    ...
    -- Processar serviços (validação robusta para arrays nulos)
    ...
    -- ========================================
    -- 5. VALIDAR ESTOQUE COM BLOQUEIO DE LINHA
    -- ========================================
    ...
    IF v_tem_produtos THEN
        ...
        LOOP
            ...
            IF (v_produto->>'quantidade')::integer > 9999 THEN
                RAISE EXCEPTION 'Quantidade do produto % excede o limite máximo', v_produto->>'nome';
            END IF;
            
            -- SELECT FOR UPDATE para bloqueio de linha
